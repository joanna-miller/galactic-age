...
describe("Mercury", () => {
  ...
  test("should correctly return a string with users age in solar years on Mercury with up to one decimal point", () => {
    const userAge = new Mercury (32,90);
    expect(userAge.mercAge()).toEqual("Wow! You are 133.3 Mercurian years old!");
  })
